...
public record EnderecoRequest(string Cep,string Logradouro,string Numero,string? Complemento,string Bairro,string Cidade,string Estado,bool Principal);
public record CriarClienteRequest(string Nome,string Cpf,string Email,string Telefone,DateOnly DataNascimento,EnderecoRequest Endereco);
public record AtualizarClienteRequest(string Nome,string Cpf,string Email,string Telefone,DateOnly DataNascimento);
